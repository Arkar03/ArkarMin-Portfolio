    ...
    <div ref={comp} className="techs">
      ...
      <div className="ml-[25%] text-lg lg:text-4xl  font-light mt-7 lg:mt-14 relative">
        <ul className="list-disc text-white marker:text-[#EA590D] text-[28px] marker:text-4xl space-y-2">
          ...
          <li className="skill5">next</li>
          <li className="ml-9 skill6">react</li>
          <li className="ml-9 skill7">mui</li>
          <li className="ml-9 skill8">express</li>
          <li className="ml-9 skill9">typescript</li>
          <li className="ml-9 skill10">node</li>
          <li className="skill11">DBMS</li>
          <li className="ml-9 skill12">MySql, MongoDB</li>
        </ul>
      </div>
    </div>
  );
